...
// Mux protocol 12; IR SHA-256 ce4a7ce926e4e65a26bc164f5e6a3fa37dde7a06b38d536baf67161a0296bb26.
...
// AgentStateChangedEvent is emitted by protocol v12.
type AgentStateChangedEvent struct {
	AgentsActive   Presence[uint64]             `json:"-"`
	Detail         Presence[string]             `json:"-"`
	JobsRunning    Presence[uint64]             `json:"-"`
	Label          Presence[string]             `json:"-"`
	Previous       RequiredNullable[AgentState] `json:"-"`
	RootSession    *bool                        `json:"root_session,omitempty"`
	Session        RequiredNullable[string]     `json:"-"`
	Source         AgentSource                  `json:"source"`
	StartedAtMs    Presence[uint64]             `json:"-"`
	State          AgentState                   `json:"state"`
	Surface        ID                           `json:"surface"`
	TasksCompleted Presence[uint64]             `json:"-"`
	TasksTotal     Presence[uint64]             `json:"-"`
	UpdatedAtMs    uint64                       `json:"updated_at_ms"`
}

func (value AgentStateChangedEvent) MarshalJSON() ([]byte, error) {
	type wire AgentStateChangedEvent
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if value.AgentsActive.IsAbsent() {
		delete(object, "agents_active")
	} else if value.AgentsActive.IsNull() {
		object["agents_active"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.AgentsActive.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentStateChangedEvent.AgentsActive: %w", err)
		}
		object["agents_active"] = encodedField
	}
	if value.Detail.IsAbsent() {
		delete(object, "detail")
	} else if value.Detail.IsNull() {
		object["detail"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.Detail.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentStateChangedEvent.Detail: %w", err)
		}
		object["detail"] = encodedField
	}
	if value.JobsRunning.IsAbsent() {
		delete(object, "jobs_running")
	} else if value.JobsRunning.IsNull() {
		object["jobs_running"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.JobsRunning.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentStateChangedEvent.JobsRunning: %w", err)
		}
		object["jobs_running"] = encodedField
	}
	if value.Label.IsAbsent() {
		delete(object, "label")
	} else if value.Label.IsNull() {
		object["label"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.Label.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentStateChangedEvent.Label: %w", err)
		}
		object["label"] = encodedField
	}
	if !value.Previous.IsSet() {
		return nil, fmt.Errorf("encode AgentStateChangedEvent: required nullable field previous is missing")
	}
	if value.Previous.IsNull() {
		object["previous"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.Previous.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentStateChangedEvent.Previous: %w", err)
		}
		object["previous"] = encodedField
	}
	if !value.Session.IsSet() {
		return nil, fmt.Errorf("encode AgentStateChangedEvent: required nullable field session is missing")
	}
	if value.Session.IsNull() {
		object["session"] = json.RawMessage("null")
	} else {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentStateChangedEvent.Session: %w", err)
		}
		object["session"] = encodedField
	}
	if value.StartedAtMs.IsAbsent() {
		delete(object, "started_at_ms")
	} else if value.StartedAtMs.IsNull() {
		object["started_at_ms"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.StartedAtMs.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentStateChangedEvent.StartedAtMs: %w", err)
		}
		object["started_at_ms"] = encodedField
	}
	if value.TasksCompleted.IsAbsent() {
		delete(object, "tasks_completed")
	} else if value.TasksCompleted.IsNull() {
		object["tasks_completed"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.TasksCompleted.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentStateChangedEvent.TasksCompleted: %w", err)
		}
		object["tasks_completed"] = encodedField
	}
	if value.TasksTotal.IsAbsent() {
		delete(object, "tasks_total")
	} else if value.TasksTotal.IsNull() {
		object["tasks_total"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.TasksTotal.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentStateChangedEvent.TasksTotal: %w", err)
		}
		object["tasks_total"] = encodedField
	}
	return json.Marshal(object)
}

func (value *AgentStateChangedEvent) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode AgentStateChangedEvent: expected object")
	}
	var fields struct {
		AgentsActive   Presence[uint64]             `json:"agents_active"`
		Detail         Presence[string]             `json:"detail"`
		JobsRunning    Presence[uint64]             `json:"jobs_running"`
		Label          Presence[string]             `json:"label"`
		Previous       RequiredNullable[AgentState] `json:"previous"`
		RootSession    optionalNonNullJSON[bool]    `json:"root_session"`
		Session        RequiredNullable[string]     `json:"session"`
		Source         *AgentSource                 `json:"source"`
		StartedAtMs    Presence[uint64]             `json:"started_at_ms"`
		State          *AgentState                  `json:"state"`
		Surface        *ID                          `json:"surface"`
		TasksCompleted Presence[uint64]             `json:"tasks_completed"`
		TasksTotal     Presence[uint64]             `json:"tasks_total"`
		UpdatedAtMs    *uint64                      `json:"updated_at_ms"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode AgentStateChangedEvent: %w", err)
	}
	type wire AgentStateChangedEvent
	var decoded wire
	decoded.AgentsActive = fields.AgentsActive
	decoded.Detail = fields.Detail
	decoded.JobsRunning = fields.JobsRunning
	decoded.Label = fields.Label
	if !fields.Previous.IsSet() {
		return fmt.Errorf("decode AgentStateChangedEvent: required field previous is missing")
	}
	decoded.Previous = fields.Previous
	if fields.RootSession.null {
		return fmt.Errorf("decode AgentStateChangedEvent: non-nullable field root_session is null")
	}
	if fields.RootSession.set {
		decoded.RootSession = &fields.RootSession.value
	}
	if !fields.Session.IsSet() {
		return fmt.Errorf("decode AgentStateChangedEvent: required field session is missing")
	}
	decoded.Session = fields.Session
	if fields.Source == nil {
		return fmt.Errorf("decode AgentStateChangedEvent: required field source is missing or null")
	}
	decoded.Source = *fields.Source
	decoded.StartedAtMs = fields.StartedAtMs
	if fields.State == nil {
		return fmt.Errorf("decode AgentStateChangedEvent: required field state is missing or null")
	}
	decoded.State = *fields.State
	if fields.Surface == nil {
		return fmt.Errorf("decode AgentStateChangedEvent: required field surface is missing or null")
	}
	decoded.Surface = *fields.Surface
	decoded.TasksCompleted = fields.TasksCompleted
	decoded.TasksTotal = fields.TasksTotal
	if fields.UpdatedAtMs == nil {
		return fmt.Errorf("decode AgentStateChangedEvent: required field updated_at_ms is missing or null")
	}
	decoded.UpdatedAtMs = *fields.UpdatedAtMs
	*value = AgentStateChangedEvent(decoded)
	return nil
}

func (AgentStateChangedEvent) EventName() string { return "agent-state-changed" }
func (AgentStateChangedEvent) isDeltaEvent()     {}
func (AgentStateChangedEvent) isSubscribeEvent() {}
...
func (value NotificationEvent) MarshalJSON() ([]byte, error) {
	...
	if value.Subtitle.IsAbsent() {
		delete(object, "subtitle")
	} else if value.Subtitle.IsNull() {
		object["subtitle"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.Subtitle.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode NotificationEvent.Subtitle: %w", err)
		}
		object["subtitle"] = encodedField
	}
...
func (value *NotificationEvent) UnmarshalJSON(data []byte) error {
	...
	var fields struct {
		...
		Level        *NotificationLevel   `json:"level"`
		Notification *ID                  `json:"notification"`
		Subtitle     Presence[string]     `json:"subtitle"`
	...
	decoded.Subtitle = fields.Subtitle
...
type SurfaceExitedEvent struct {
	...
	RuntimeMs Presence[uint64] `json:"-"`
	Surface   ID               `json:"surface"`
}
...
func (value SurfaceExitedEvent) MarshalJSON() ([]byte, error) {
	...
	if value.RuntimeMs.IsAbsent() {
		delete(object, "runtime_ms")
	} else if value.RuntimeMs.IsNull() {
		object["runtime_ms"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.RuntimeMs.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode SurfaceExitedEvent.RuntimeMs: %w", err)
		}
		object["runtime_ms"] = encodedField
	}
	return json.Marshal(object)
}
...
func (value *SurfaceExitedEvent) UnmarshalJSON(data []byte) error {
	...
	var fields struct {
		RuntimeMs Presence[uint64] `json:"runtime_ms"`
		Surface   *ID              `json:"surface"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
	...
	type wire SurfaceExitedEvent
	var decoded wire
	decoded.RuntimeMs = fields.RuntimeMs
	if fields.Surface == nil {
...
func parseEvent(raw map[string]any) Event {
	...
	case "agent-state-changed":
		var event AgentStateChangedEvent
		if decodeEvent(raw, &event) {
			return event
		}
	case "bell":

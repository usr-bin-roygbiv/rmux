...
func (value AgentRecord) MarshalJSON() ([]byte, error) {
	...
	if value.AgentsActive.IsAbsent() {
		...
		if err != nil {
			return nil, fmt.Errorf("encode AgentRecord.AgentsActive: %w", err)
		}
	...
	if value.Detail.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentRecord.Detail: %w", err)
		}
	...
	if value.JobsRunning.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentRecord.JobsRunning: %w", err)
		}
	...
	if value.Label.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentRecord.Label: %w", err)
		}
	...
	if value.StartedAtMs.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentRecord.StartedAtMs: %w", err)
		}
	...
	if value.TasksCompleted.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentRecord.TasksCompleted: %w", err)
		}
	...
	if value.TasksTotal.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode AgentRecord.TasksTotal: %w", err)
		}
...
func (value *AgentRecord) UnmarshalJSON(data []byte) error {
	...
	if fields.RootSession.null {
		return fmt.Errorf("decode AgentRecord: non-nullable field root_session is null")
	}
...
func (value AgentState) valid() bool {
	switch value {
	case AgentStateWorking, AgentStateBlocked, AgentStateIdle, AgentStateDone, AgentStateError, AgentStateUnknown:
		return true
	default:
		return false
	}
...
func (value ReportAgentResult) MarshalJSON() ([]byte, error) {
	...
	if value.AgentsActive.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode ReportAgentResult.AgentsActive: %w", err)
		}
		object["agents_active"] = encodedField
	}
	if value.Detail.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode ReportAgentResult.Detail: %w", err)
		}
		object["detail"] = encodedField
	}
	if value.JobsRunning.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode ReportAgentResult.JobsRunning: %w", err)
		}
		object["jobs_running"] = encodedField
	}
	if value.Label.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode ReportAgentResult.Label: %w", err)
		}
		object["label"] = encodedField
	}
	if !value.Session.IsSet() {
	...
	if value.StartedAtMs.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode ReportAgentResult.StartedAtMs: %w", err)
		}
		object["started_at_ms"] = encodedField
	}
	if value.TasksCompleted.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode ReportAgentResult.TasksCompleted: %w", err)
		}
		object["tasks_completed"] = encodedField
	}
	if value.TasksTotal.IsAbsent() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode ReportAgentResult.TasksTotal: %w", err)
		}
		object["tasks_total"] = encodedField
	}
	return json.Marshal(object)
...
func (value *ReportAgentResult) UnmarshalJSON(data []byte) error {
	...
	decoded.Label = fields.Label
	if fields.RootSession.null {
		return fmt.Errorf("decode ReportAgentResult: non-nullable field root_session is null")
	}
	if fields.RootSession.set {
		decoded.RootSession = &fields.RootSession.value
	}
